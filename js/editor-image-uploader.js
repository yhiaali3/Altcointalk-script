// Minimal image uploader for Altcointalks-style editors
...
(function () {
    ...
    function createUploadButton() {
        ...
        btn.className = 'altcoinstalks-image-upload-button';
    ...
    function attachUploaderTo(textarea) {
        ...
        var previewButtons = Array.from(form.querySelectorAll('input[type=button], input[type=submit], button, a')).filter(function (el) {
            ...
            // match common English preview keywords or generic 'preview' class/attr
            return /preview|view|display/.test(txt) || /preview/.test(cls) || el.dataset && el.dataset.action === 'preview';
        });
